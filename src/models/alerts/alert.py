...
class Alert(object):
    ...
    def send(self):
        return requests.post(
            ...
            data={
                ...
                "to": self.user_email,
                "subject": "price limit for {} reached {}".format(self.item.name,self.item.price),
                "text": "we have found a deal , The link for product is {} To navigate through alert {}".format(self.item.url,"http://pricing.jslvtr.com/alerts/{}".format(self._id))
            }
    ...
    def find_needing_update(cls, minutes_since_update=AlertConstants.ALERT_TIMEOUT):
        ...
        return [cls(**elem) for elem in
                Database.find(AlertConstants.COLLECTION, {"last_checked": {"$lte": last_updated_limit},"active":True
                                                          })]
